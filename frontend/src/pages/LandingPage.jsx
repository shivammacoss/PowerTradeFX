          ...
          <div className="flex flex-col max-w-[480px]">
            ...
            <div className="mt-auto">
              <p className="text-[12px] leading-[1.6] text-black/70">
                Stock Tokens are derivative contracts between you and PowerTradeFX. They are priced at the prices of the underlying securities without granting rights to them. Stock Tokens carry a high level of risk and are not appropriate for all investors.
              </p>
            </div>
          </div>
        </div>
    ...
    <section className="relative w-full min-h-[720px] lg:h-[840px] flex items-center overflow-hidden">
      <div className="absolute inset-0 z-0">
        <img
          ...
          alt="Metallic chain detail for Crypto"
      ...
      <div className="max-w-[1440px] mx-auto px-6 md:px-[60px] relative z-10">
        <div className="max-w-[480px]">
          <div className="mb-8 flex items-center gap-2">
            <span className="text-white text-[24px] font-semibold">PowerTradeFX Crypto</span>
          </div>
          <h1 className="text-white mb-6 leading-[1.1] tracking-[-0.02em] text-[48px] md:text-[64px] font-light">
        ...
        <div className="flex flex-col lg:flex-row items-center lg:items-start gap-[64px] lg:gap-[80px]">
          ...
          <div className="w-full lg:w-[480px] flex flex-col pt-0 lg:pt-[40px]">
            <div className="mb-[12px]">
              <h3 className="text-[#999999] text-[14px] md:text-[18px] font-medium tracking-normal leading-[1.2]">
                Perpetual Futures
              </h3>
            </div>
            <div className="mb-[24px]">
              <h2 className="text-[40px] md:text-[48px] leading-[1.1] font-light text-white">
            ...
            <div className="mt-auto">
              <p className="text-[12px] md:text-[14px] leading-[1.5] text-[#999999]">
                Perpetual futures are complex derivative products, and trading involves significant risk. Leveraged trading can amplify the speed of your losses. Carefully consider if this product is appropriate for you.
              </p>
            </div>
          </div>
        </div>
    ...
    <section className="relative w-full min-h-[800px] flex items-center justify-center overflow-hidden bg-[#000000]">
      ...
      <div className="relative z-20 max-w-[1440px] mx-auto px-[60px] text-center">
        <div className="flex flex-col items-center justify-center">
          ...
          <h2 className="text-white text-[42px] md:text-[64px] lg:text-[72px] leading-[1.05] tracking-[-0.03em] max-w-[900px] mx-auto mb-[40px] font-light">
      ...
      <div className="max-w-[1440px] mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
              ...
              <div>
                ...
                <ul className="space-y-3">
                  {['Invest', 'Crypto', 'Perpetual Futures', 'Staking'].map((item) => (
                    <li key={item}><a href="#" className="text-[14px] hover:underline whitespace-nowrap">{item}</a></li>
                  ))}
                </ul>
              </div>
              <div>
                ...
                <ul className="space-y-3 text-[14px]">
                  {['Bitcoin (BTC)', 'Solana (SOL)', 'USDC (USDC)', 'Ethereum (ETH)', 'See more'].map((item) => (
                    <li key={item}><a href="#" className="hover:underline whitespace-nowrap">{item}</a></li>
                  ))}
                </ul>
              </div>
              <div>
                ...
                <ul className="space-y-3 text-[14px]">
                  {['About us', 'Blog', 'Support', 'Terms & Conditions'].map((item) => (
                    <li key={item}><a href="#" className="hover:underline whitespace-nowrap">{item}</a></li>
                  ))}
                </ul>
              </div>
          ...
          <div className="space-y-6 text-[12px] leading-[1.6]">
            <p>
              Stock Tokens are derivative contracts between you and PowerTradeFX. They carry a high level of risk and are not appropriate for all investors. Please review all associated risks before investing.
            </p>
            <p>
              Perpetual futures are complex derivative products, and trading involves significant risk. Leveraged trading can amplify your losses. Carefully consider if this product is appropriate for you.
            </p>
            <p>PowerTradeFX © 2025. All rights reserved.</p>
          </div>
        </div>
        <div className="mt-12 pt-8 border-t border-black/10 text-center">
          <h1 className="text-[48px] md:text-[72px] lg:text-[96px] font-bold tracking-tighter">
            PowerTradeFX
          </h1>
        </div>
      </div>
