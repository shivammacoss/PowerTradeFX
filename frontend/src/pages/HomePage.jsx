      ...
      <nav className={`fixed top-0 left-0 right-0 z-[100] w-full border-b transition-all duration-300 ${
        ...
        <div className="mx-auto flex h-[70px] md:h-[86px] max-w-[1440px] items-center justify-between px-4 md:px-6 xl:px-8">
          <div className="flex shrink-0 items-center">
            <a href="/" className="flex items-center" aria-label="PowerTradeFX Home">
              <img 
                src={logoImage} 
        ...
        <div className="relative flex w-full max-w-[1200px] flex-col items-center">
          ...
          >
            <span className="text-[10px] sm:text-xs font-semibold tracking-wide uppercase md:text-sm">
              PowerTradeFX White Label — Launch in 15 Days
            </span>
          ...
          <div className="max-w-[1000px] text-center px-2">
            <h1 className="text-[28px] sm:text-[36px] leading-[1.15] font-medium tracking-tight md:text-[56px] lg:text-[72px]">
              PowerTradeFX — Empowering Forex Brokers with White Label Solution
            </h1>
          </div>
          ...
          <div className="mt-12 sm:mt-20 w-full max-w-[1000px]">
            <div className="mb-6 sm:mb-10 text-center">
              <h2 className="text-lg sm:text-xl md:text-2xl font-medium text-white/90">Unlock Boundless Growth with PowerTradeFX's White Label Solutions</h2>
            </div>
        ...
        <div className="relative rounded-2xl border border-gray-800 bg-gray-900 p-2 shadow-2xl transition-transform duration-500 hover:scale-[1.01]">
          <div className="relative aspect-[16/9] w-full overflow-hidden rounded-xl">
            <img
              ...
              alt="PowerTradeFX Trading Dashboard Preview"
      ...
      <div className="mx-auto px-4 sm:px-6 md:px-8 max-w-[1200px]">
        <div className="mb-8 sm:mb-12">
          <h2 className="text-[28px] sm:text-[36px] md:text-[48px] font-medium leading-[1.2] tracking-[-0.01em] text-black max-w-[974px]">
            Unlock Boundless Growth with PowerTradeFX's White Label Solutions
          </h2>
        </div>
      ...
      <div className="mx-auto px-4 sm:px-6 max-w-[1200px]">
        <div className="flex flex-col items-center text-center mb-10 sm:mb-16">
          ...
          <h2 className="text-[28px] sm:text-[36px] md:text-[48px] font-semibold text-white leading-[1.2] mb-4 sm:mb-6 tracking-tight">
            Features of PowerTradeFX White-Label Solutions
          </h2>
...
const FAQSection = () => {
  ...
  const faqData = [
    {
      question: "What liquidity solutions does PowerTradeFX provide?",
      answer: "PowerTradeFX offers access to deep, multi-asset liquidity with stable execution, competitive spreads, and scalable infrastructure suitable for both new and growing brokerage firms."
    },
    {
      question: "How does PowerTradeFX support new and existing brokerage firms?",
    ...
    },
    {
      ...
      answer: "Yes. PowerTradeFX handles the complete technical setup, integrations, and backend configuration, allowing you to focus on client acquisition and business growth."
    },
    {
      question: "Does PowerTradeFX offer customization and branding?",
    ...
    {
      question: "What makes PowerTradeFX different from other white-label providers?",
      answer: "PowerTradeFX combines fast deployment, enterprise-grade technology, transparent pricing, and expert support to help brokers launch faster and scale with confidence."
    }
  ]
      ...
      <div className="mx-auto px-4 sm:px-6 max-w-[900px]">
        <div className="text-center mb-10 sm:mb-16">
          <h2 className="text-[24px] sm:text-[32px] md:text-[48px] font-bold text-white mb-4 sm:mb-6 tracking-tight">
            Frequently Asked Questions About <span className="text-[#ff4d4d]">PowerTradeFX</span> White-Label Solutions
          </h2>
          ...
          <div className="col-span-2 sm:col-span-2 lg:col-span-4 flex flex-col gap-6 sm:gap-8">
            <div className="flex flex-col gap-4 sm:gap-6">
              ...
              <p className="text-[#a0a0a0] text-xs sm:text-sm leading-relaxed max-w-[320px]">
                PowerTradeFX is a technology and service provider, empowering Forex brokers with white-label solutions.
              </p>
            </div>

            <div className="flex flex-col gap-1 text-[#a0a0a0] text-xs sm:text-sm">
              <p className="font-bold text-white mb-1">PowerTradeFX</p>
            ...
            <div className="flex gap-4 sm:gap-5">
              ...
              <a 
                href="https://www.facebook.com/PowerTradeFX" 
                target="_blank" 
                rel="noopener noreferrer"
                className="text-[#a0a0a0] hover:text-white transition-colors"
                aria-label="Facebook"
