...
const HomePage = () => {
  ...
  const testimonials = [
    {
      ...
      content: 'PowerTradeFx has transformed my trading experience. The platform is incredibly fast and reliable.',
      rating: 5
    },
    {
      name: 'Sarah Johnson',
  ...
  return (
    <div className="min-h-screen bg-black text-white overflow-x-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-24">
            <div className="flex items-center gap-3">
              <img src={logo} alt="PowerTradeFx" className="h-16 sm:h-20 md:h-24 object-contain" />
            </div>
            <div className="hidden md:flex items-center gap-8">
              <a href="#features" onClick={(e) => handleNavClick(e, 'features')} className="text-gray-300 hover:text-white transition-colors">Features</a>
              <a href="#stats" onClick={(e) => handleNavClick(e, 'stats')} className="text-gray-300 hover:text-white transition-colors">Stats</a>
              <a href="#testimonials" onClick={(e) => handleNavClick(e, 'testimonials')} className="text-gray-300 hover:text-white transition-colors">Testimonials</a>
            </div>
            <div className="flex items-center gap-2 sm:gap-4 flex-wrap justify-end">
              <button 
                onClick={() => window.location.href = '/user/login'}
                className="text-white hover:text-yellow-400 transition-colors font-medium text-sm sm:text-base"
              >
                Login
              </button>
              <button 
                onClick={() => window.location.href = '/user/signup'}
                className="bg-gradient-to-r from-yellow-500 to-amber-500 hover:from-yellow-600 hover:to-amber-600 text-black px-4 sm:px-6 py-2.5 rounded-full font-medium transition-all transform hover:scale-105 text-sm sm:text-base"
              >
                Get Started
              </button>
            </div>
      ...
      {/* Features Section */}
      <section id="features" className="py-20 bg-gradient-to-b from-black to-gray-900 scroll-mt-28">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl sm:text-4xl font-bold mb-4">
              Why Choose <span className="text-yellow-400">PowerTradeFx</span>?
            </h2>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {features.map((feature, index) => (
              <div 
                key={index}
                className="group bg-gradient-to-br from-gray-800/50 to-gray-900/50 rounded-2xl p-6 border border-gray-700/50 hover:border-yellow-400/50 transition-all duration-300 hover:transform hover:-translate-y-2"
              >
                <div className="w-14 h-14 bg-yellow-400/15 rounded-xl flex items-center justify-center text-yellow-400 mb-4 group-hover:bg-yellow-400 group-hover:text-black transition-all">
                  {feature.icon}
                </div>
      ...
      {/* Stats Section */}
      <section id="stats" className="py-20 bg-gray-900 relative overflow-hidden scroll-mt-28">
        <div className="absolute inset-0 bg-gradient-to-r from-yellow-500/10 to-amber-500/10" />
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-3xl sm:text-4xl font-bold mb-6">
                Trusted by Traders <span className="text-yellow-400">Worldwide</span>
              </h2>
              <p className="text-gray-400 mb-8">
                Join thousands of successful traders who have chosen PowerTradeFx as their preferred trading platform. 
            ...
            <div className="grid grid-cols-2 gap-6">
              {stats.map((stat, index) => (
                <div key={index} className="bg-black/50 backdrop-blur-sm rounded-2xl p-6 border border-gray-700 text-center">
                  <div className="text-3xl sm:text-4xl font-bold bg-gradient-to-r from-yellow-300 to-amber-400 bg-clip-text text-transparent">
                    {stat.value}
                  </div>
      ...
      <section id="testimonials" className="py-20 bg-black scroll-mt-28">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl sm:text-4xl font-bold mb-4">
              What Our <span className="text-yellow-400">Traders</span> Say
            </h2>
            <p className="text-gray-400 max-w-2xl mx-auto">
              Real stories from real traders who have achieved success with PowerTradeFx
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {testimonials.map((testimonial, index) => (
              ...
              >
                ...
                <div className="flex items-center gap-3">
                  <div className="w-12 h-12 bg-gradient-to-br from-yellow-500 to-amber-500 rounded-full flex items-center justify-center text-black font-bold">
      ...
      <section className="py-20 bg-gradient-to-r from-yellow-500 to-amber-500 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          ...
          <p className="text-white/80 text-lg mb-8 max-w-2xl mx-auto">
            Join PowerTradeFx today and get access to world-class trading tools, 
            educational resources, and 24/7 support.
          </p>
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <button 
              onClick={() => window.location.href = '/user/signup'}
              className="bg-black text-yellow-300 px-8 py-4 rounded-full font-semibold text-lg hover:bg-black/90 transition-all transform hover:scale-105"
            >
              Create Free Account
            </button>
            <button 
      ...
      <footer className="bg-gray-900 py-12 border-t border-gray-800">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-4 gap-8 mb-8">
            <div>
              <img src={logo} alt="PowerTradeFx" className="h-14 sm:h-16 md:h-20 object-contain mb-4" />
          ...
          <div className="border-t border-gray-800 pt-8 text-center text-gray-400 text-sm">
            <p>© 2026 PowerTradeFx. All rights reserved.</p>
